      ...
      <div class="col-md-3 col-lg-2 bg-body-tertiary sidebar collapse d-md-block p-3" id="sidebarMenu">
        <ul class="nav flex-column gap-1">
          ...
          <?php if ($role === 'dosen' || $role === 'admin'): ?>
            <li class="nav-item">
              <a class="nav-link active" href="dosen.php"><i class="bi bi-table me-2"></i> Daftar Dosen</a>
            </li>
          <?php endif; ?>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <button class="btn btn-success btn-sm me-1 edit-button" data-bs-toggle="modal" data-bs-target="#editDataModal" data-nidn="<?= $data['nidn']; ?>" data-nama="<?= $data['nama']; ?>" data-alamat="<?= $data['alamat']; ?>" data-jabatan="<?= $data['jabatan']; ?>">
                          <i class="fas fa-edit"></i> Edit
                        </button>
                        <a href="hapus_dosen.php?nidn=<?= $data['nidn']; ?>" class="btn btn-danger btn-sm" onclick="confirmDelete(event, this.href)">
